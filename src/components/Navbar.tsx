  ...
  return (
    ...
    <nav className="mx-auto mt-7 flex w-full max-w-6xl justify-between px-8">
      <div className="my-auto flex">
        <Menu onClick={() => setIsOpen(!isOpen)} className="sm:hidden cursor-pointer h-10 w-10 mr-2" />
        <svg
          xmlns="http://www.w3.org/2000/svg"
          version="1"
          viewBox="0 0 500 500"
          className="h-12 w-12 fill-current hidden sm:block text-foreground"
        >
          <path
      ...
      <div className="my-auto hidden sm:flex gap-6 font-semibold">
      ...
      <Button
        variant="outline"
        className="text-sm sm:text-md flex w-max gap-2 rounded-full py-2 font-semibold"
      >
    ...
    {isOpen && <div className="bg-white/10 fixed inset-y-0 w-full">
      <nav className="sm:hidden bg-background fixed inset-y-0 w-3/4 px-8 py-12 rounded-r-3xl">
        <span className="flex justify-between">
          ...
          <Button variant="outline" className="my-aut" onClick={() => setIsOpen(false)}>
            <XIcon />
          </Button>
        </span>
        <ul className="py-8 text-lg">
          ...
          <Link href="https://github.com/Judge-Paul/playlist-pro" className="block my-3">
            Contribute
          </Link>
        </ul>
      </nav>
      <div onClick={() => setIsOpen(false)} className="fixed inset-y-0 w-1/4 right-0">
